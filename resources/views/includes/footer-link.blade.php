<section id="footer">
    <footer>
            ...
            <div class="container clear-padding">
                <div class="col-lg-4 col-md-5 col-sm-12 col-xs-12 no-padding about-box" style="line-height:30px;">
                    ...
                    <p> Just concentrate on our name and it describes all. Providing the variety of travel
                        products with matchless Services at economical rates to all parts of the world by making reservation
                ...
                <div class="col-lg-offset-1 col-lg-3 col-md-4 col-sm-6 col-xs-12 links">
                    ...
                    <div class="row main-footer-sub">
                        <form action="{{route('footer.newsletter')}}" method="POST" autocomplete="off">
                            @csrf
                            <input class="form-control" type="email" placeholder="Enter Your Email" required name="nemail" id="nemail">
                            <p>* We do not send spam.</p>
                            <button class="subs_button" type="submit"> <i class="fa fa-paper-plane"></i>SUBSCRIBE </button>
                        </form>
                    </div>
                </div>
                <div class="col-lg-offset-1 col-lg-3 col-md-3 col-sm-6 col-xs-12 contact-box">
                    ...
                    <p>
                        ...
                        <a style="color:#FFF;" href="https://api.whatsapp.com/send?phone=&amp;text=I'm%20interested%20in%20flights%20deals">
            ...
            <div class="container clear-padding">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 we-accept">
                    <ul>
                        ...
                        <li>
                            <img width="51" src="{{asset('assets/images/payment/visaelectron.png')}}" alt="visaelectron">
                        </li>
                    </ul>
                </div>
                <div class="col-lg- 3 col-md-3 col-sm-3 col-xs-12 hidden-xs hidden-sm">

                        <img style="border-radius: 10px;" src="{{asset('assets/images/payment/baclays-power.png')}}" height="54px" width="184px"
                             alt="Barclay's Power Logo" class="barclay text-center" />
        ...
        <div style="background: #041321;" class="col-xs-12">
            <p style="margin: 5px 0;color: #ffffff; font-size:12px;" class="text-center">&copy; 2023 zistravels.co.uk</p>
        </div>
    </footer>
</section>
