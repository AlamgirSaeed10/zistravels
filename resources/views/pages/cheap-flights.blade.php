                    ...
                    <div class="col-md-12 offer-slider">
                        <div class="owl-carousel text-right" id="offer1">
                            ...
                            <div class="item item-bg trans-blue">
                                <div class="row">
                                    <div class="col-md-3 text-center no-padding p-0-5">
                                        <img src="./assets/images/airlines-jpg/TK.jpg">
                                    </div>
                                    <div class="col-md-9 no-padding">
                                        <h4 class="min_airline">
                                            Turkish Airlines<br>
                            ...
                            <div class="item item-bg trans-blue">
                                <div class="row">
                                    <div class="col-md-3 text-center no-padding p-0-5">
                                        <img src="./assets/images/airlines-jpg/EK.jpg">
                                    </div>
                                    <div class="col-md-9 no-padding">
                                        <h4 class="min_airline">
                                            Emirates<br>
                            ...
                            <div class="item item-bg trans-blue">
                                <div class="row">
                                    <div class="col-md-3 text-center no-padding p-0-5">
                                        <img src="./assets/images/airlines-jpg/QR.jpg">
                                    </div>
                                    <div class="col-md-9 no-padding">
                                        <h4 class="min_airline">
                                            Qatar Airways<br>
                            ...
                            <div class="item item-bg trans-blue">
                                <div class="row">
                                    <div class="col-md-3 text-center no-padding p-0-5">
                                        <img src="./assets/images/airlines-jpg/LH.jpg">
                                    </div>
                                    <div class="col-md-9 no-padding">
                                        <h4 class="min_airline">
                                            Lufthansa<br>
                            ...
                            <div class="item item-bg trans-blue">
                                <div class="row">
                                    <div class="col-md-3 text-center no-padding p-0-5">
                                        <img src="./assets/images/airlines-jpg/QH.jpg">
                                    </div>
                                    <div class="col-md-9 no-padding">
                                        <h4 class="min_airline">
                                            <br>
                            ...
                            <div class="item item-bg trans-blue">
                                <div class="row">
                                    <div class="col-md-3 text-center no-padding p-0-5">
                                        <img src="./assets/images/airlines-jpg/AI.jpg">
                                    </div>
                                    <div class="col-md-9 no-padding">
                                        <h4 class="min_airline">
                                            Air India<br>
        ...
        <div class="row last-minute-deal">
            <div class="container">
                ...
                <div class="owl-carousel" id="lastminute">
                    ...
                    <div class="col-grid">
                        <div class="wrapper"> <img src="assets/images/destinations/ADD.jpg" alt="Last Minute Flights To Addis Ababa">
                    ...
                    <div class="col-grid">
                        <div class="wrapper"> <img src="assets/images/destinations/MNL.jpg" alt="Last Minute Flights To Manila">
                    ...
                    <div class="col-grid">
                        <div class="wrapper"> <img src="assets/images/destinations/DPS.jpg" alt="Last Minute Flights To Denpasar">
                    ...
                    <div class="col-grid">
                        <div class="wrapper"> <img src="assets/images/destinations/JNB.jpg" alt="Last Minute Flights To Johannesburg">
                    ...
                    <div class="col-grid">
                        <div class="wrapper"> <img src="assets/images/destinations/LUN.jpg" alt="Last Minute Flights To Lusaka">
                    ...
                    <div class="col-grid">
                        <div class="wrapper"> <img src="assets/images/destinations/LOS.jpg" alt="Last Minute Flights To Lagos">
                    ...
                    <div class="col-grid">
                        <div class="wrapper"> <img src="assets/images/destinations/FNA.jpg" alt="Last Minute Flights To Freetown">
                    ...
                    <div class="col-grid">
                        <div class="wrapper"> <img src="assets/images/destinations/NBO.jpg" alt="Last Minute Flights To Nairobi">
        ...
        <div style="padding-top:0;" class="row top-flight">
            <div class="container">
                <div class="section-title text-center color-text clrblack">
                    ...
                    <h4 style="float:left;">Book cheap flights on Reliance Travels</h4>
                    <p style="color:#000; float:left; text-align:left;"><a href="https://www.reliancetravels.co.uk/">Reliance Travels LTD</a> in comparison to 800+ airlines, book for both regular and budget airlines, that fly to 9000+ destinations throughout the world. Are you planning a trip to Africa, want to see Bangkok, or want to take a cultural tour of Europe? You've arrived to the right location. We'll assist you in finding the best flight prices all across the world. Our website is accessible on any device, whether at home, at work, or in the pub. Book your <b>cheap air tickets</b> as soon as possible, no matter where you are!</p>

                    <h4 style="float:left;">How can you get cheap flight tickets?</h4>
                    <p style="color:#000; float:left; text-align:left;">
                        <li>There could be cheap plane tickets offers available at any time! It's a good idea to look for flights on Tuesday and book flights on Wednesday. </li>
                        <li>It's best to purchase your tickets at least 4-5 months in advance. </li>
                        <li> Do you feel like stealing a deal? Check out some of our <a href="https://www.reliancetravels.co.uk/cheap-flights.html">last minute deals</a> for special airline offers and active discount codes.</li>
                        <li> Last-minute bargains might also help you save money. However, you'll need some luck because prices fluctuate depending on the season and availability. </li>
                        <li>Flying with multiple carriers or from different airports on the way there and back may also assist keep the vacation budget low. During the search process, use our filters to discover the ticket that best meets your needs.</li>
                    </p>


                    <h4 style="float:left;">Why are airline ticket prices so different?</h4>
                    <p style="color:#000; float:left; text-align:left;">The price of a plane ticket is determined by a number of factors. The airline determines the price of an airline ticket first. The pricing varies depending on the booking class. Ticket prices are often lower if you book a flight months ahead of time. The prices of airline tickets for this flight will go down or merely rise in the week before the flight departs, depending on the airline's purpose and market demand. Changes in fuel prices, airport taxes, and maintenance costs are all factors that affect airline prices.</p>


                    <h4 style="float:left;">What name should I write on the airline ticket?</h4>
                    <p style="color:#000; float:left; text-align:left;">The name you must fill out on your cheap plane ticket must match the name on your passport. That is to say, the first and last names on the passport. You are not required to include your middle name. Pay close attention to the name you write down when making your reservation, as changing it afterwards can be costly! If your name is incorrect on your e-ticket, please notify us as soon as possible to avoid incurring additional fees.</p>


                    <h4 style="float:left;">How can I purchase to and from destination flights?</h4>
                    <p style="color:#000; float:left; text-align:left;">Do you wish to book <a href="https://www.reliancetravels.co.uk/cheap-flights.html">cheap flight tickets</a> to Singapore and return ticket at the same time? That's a great idea! You can create your own itinerary by booking round trip flights in one transaction. In our search box, select the ‘round trip’ option instead of one way. You have the option of flying back from a different airport than the one where you arrived.</p>
                </div>
            </div>
        </div>
