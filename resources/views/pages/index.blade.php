 ...
 <form autocomplete="off" method="post" action="{{ route('search.online_search') }}"> @csrf <div class="row">
     ...
     <div class="col-md-2  visible-lg visible-md">
       <div class="price-Guaranteed">
         <img style="float:left; margin-right:10px;" src="{{ asset('assets/images/bestprice.png') }}" alt="Best Price" width="80" height="70">
       </div>
     </div>
   </div>
   <div class="row">
                    ...
                    <div class="row work-row">
                        <div class="container">
                            <div style="margin-bottom:0;" class="section-title text-center">
                                <h1>Welcome To <strong>Zistravels Ltd.</strong>
                                </h1>
                                <p> Thank you for your stay at our web portal which serves as one stop solution for all your
                                    itinerary needs. The team of <strong>Zistravels Ltd</strong> cordially welcomes
                                    you and
                        ...
                        <div class="td-overlay">
                            <div class="container pd-10">
                                <div class="light-section-title text-center">
                                    ...
                                    <div class="space"></div>
                                    <p style="text-align:center;"> At Zistravels , we aim to facilitate our
                                        customers
                                        with
