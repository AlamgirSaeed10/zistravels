...
@endif
        <form action="{{ route('search.online_search') }}" method="post">
            @csrf
            <label for="departure">Departure Airport:</label>
            <select name="departure" id="departure">
                @foreach ($airports as $airport)
                    <option value="{{ $airport->city }} - {{ $airport->code }}">{{ $airport->city }} - {{ $airport->code }}</option>
                @endforeach
            </select>
                                        ...
                                        <form autocomplete="off" method="post" action="{{ route('search.online_search') }}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8 col-sm-12 col-xs-12 no-padding">
                                                    <div class="row">
                                                        <div class="col-md-12 product-search-title">Find Your Perfect Trip
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                                        ...
                                                                        <div class="cabin_class">
                                                                            <div class="select-box">
                                                                                <div class="select-box__current"
                                                                                    ...
                                                                                    <div class="select-box__value">
                                                                                        <input class="select-box__input"
                                                                                            type="radio" id="Economy"
                                                                                            value="Economy"
                                                                                            name="cabin_class" checked />
                                                                                        <p class="select-box__input-text">
                                                                                            Economy</p>
                                                                                    </div>
                                                                                    <div class="select-box__value">
                                                            ...
                                                            <div class="passengers_details">
                                                                <div class="inn_pax">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-xs-6 search-col-padding">
                                                                            <input type="text" id="infant_count"
                                                                                name="pinfants" value="0"
                                                                                class="form-control quantity-padding">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="col-md-4  visible-lg visible-md">
                                                    <div class="price-Guaranteed">
                                                        <img style="float:left; margin-right:10px;"
                                                            src="assets/images/bestprice.png" alt="Best Price"
                                                            width="50" height="43">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select name="flight_from" id="" class="form-control">
                                                            ...
                                                            @foreach ($dept_airport as $value)
                                                                <option value="{{ $value->city }} - {{ $value->code }}">{{ $value->city }} - {{ $value->code }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-md-5 col-sm-9 col-xs-12 no-padding">
                                                    <div class="col-md-6 col-xs-6 search-col-padding">
                                                        ...
                                                        <div class="input-group">
                                                            <input name="departure_date" type="text"
                                                                ...
                                                                placeholder="Enter Departure Date" readonly>
                                                            <span class="input-group-addon">
                                                    ...
                                                    <div
                                                        class="col-md-6 col-xs-6 search-col-padding return-date-selection">
                                                        <label>Return Date</label>
                                                        <div class="input-group">
                                                            <input name="return_date" type="text" class="form-control"
                                                                id="return_date" placeholder="Enter Returing Date"
                                                                readonly>
                                                            <span class="input-group-addon">
                                                                <i class="fa fa-calendar fa-fw"></i>
                                                            </span>
                        ...
                        <div class="col-md-12 offer-slider">
                            <div class="owl-carousel text-right" id="offer1">
                                <div class="item item-bg">
                                    <h3>Hong Kong</h3>
                                    <h4>Starting From £ <span style="color:#f79617; font-size:20px;">613.6000</span>/Person
                                    </h4>
                                    <a href="/Flights-To-Hong-Kong">Book Now</a>
                                </div>
                                <div class="item item-bg">
                                    <h3>Manila</h3>
                                    <h4>Starting From £ <span style="color:#f79617; font-size:20px;">667.2000</span>/Person
                                    </h4>
                                    <a href="/Flights-To-Manila">Book Now</a>
                                </div>
                                <div class="item item-bg">
                                    <h3>Entebbe</h3>
                                    <h4>Starting From £ <span style="color:#f79617; font-size:20px;">461.6000</span>/Person
                                    </h4>
                                    <a href="/Flights-To-Entebbe">Book Now</a>
                                </div>
                                <div class="item item-bg">
                                    <h3>Singapore</h3>
                                    <h4>Starting From £ <span style="color:#f79617; font-size:20px;">503.2000</span>/Person
                                    </h4>
                                    <a href="/Flights-To-Singapore">Book Now</a>
                                </div>
                                <div class="item item-bg">
                                    <h3>Brisbane</h3>
                                    <h4>Starting From £ <span
                                            style="color:#f79617; font-size:20px;">1311.2000</span>/Person </h4>
                                    <a href="/Flights-To-Brisbane">Book Now</a>
                                </div>
                                <div class="item item-bg">
                                    <h3>Kathmandu</h3>
                                    <h4>Starting From £ <span style="color:#f79617; font-size:20px;">612.0000</span>/Person
                                    </h4>
                                    <a href="/Flights-To-Kathmandu">Book Now</a>
                                </div>
                                <div class="item item-bg">
                                    <h3>Kuala Lumpur</h3>
                                    <h4>Starting From £ <span style="color:#f79617; font-size:20px;">569.6000</span>/Person
                                    </h4>
                                    <a href="/Flights-To-Kuala-Lumpur">Book Now</a>
                                </div>
                                <div class="item item-bg">
                                    <h3>Cebu</h3>
                                    <h4>Starting From £ <span style="color:#f79617; font-size:20px;">828.8000</span>/Person
                                    </h4>
                                    <a href="/Flights-To-Cebu">Book Now</a>
                                </div>
                                <div class="item item-bg">
                                    <h3>Goa</h3>
                                    <h4>Starting From £ <span style="color:#f79617; font-size:20px;">420.8000</span>/Person
                                    </h4>
                                ...
                                <div class="item item-bg">
                                    <h3>Sydney</h3>
                                    <h4>Starting From £ <span
                                            style="color:#f79617; font-size:20px;">1002.4000</span>/Person </h4>
                                    <a href="/Flights-To-Sydney">Book Now</a>
                                </div>
                                <div class="item item-bg">
                                    <h3>Dar es Salaam</h3>
                                    <h4>Starting From £ <span style="color:#f79617; font-size:20px;">373.6000</span>/Person
                                    </h4>
                                    <a href="/Flights-To-Dar-es-Salaam">Book Now</a>
                                </div>
                                <div class="item item-bg">
                                    <h3>Bangkok</h3>
                                    <h4>Starting From £ <span style="color:#f79617; font-size:20px;">520.0000</span>/Person
                                    </h4>
                ...
                <div class="container">
                    <div style="margin-bottom:0;" class="section-title text-center">
                        ...
                        <p> Thank you for your stay at our web portal which serves as one stop solution for all your
                            itinerary needs. The team of <strong>Zistravels Travels Ltd</strong> cordially welcomes you and
                            thank you in sparing out your precious moments on visiting our site. Our team comprises of
                            travel connoisseurs who expertise in providing itinerary solutions at a very cheap rate in
                ...
                <div class="td-overlay">
                    <div class="container pd-10">
                        <div class="light-section-title text-center">
                            ...
                            <div class="space"></div>
                            <p style="text-align:center;"> At Zistravels Travels, we aim to facilitate our customers with
                                incomparable rates and flexible payment plans. You may want to explore further, and can
                                'contact us' any time to learn more on the fares to your preferred top destination. </p>
                        </div>
                            ...
                            <div class="col-md-4 col-sm-4 td-product text-center clear-padding wow slideInUp"
                                ...
                                <div class="overlay">
                                    <div class="wrapper">
                                        ...
                                        <p>Visiting Freetown this season then call us for the cheapest rates for your
                                            flights.</p>
                            ...
                            <div class="col-md-4 col-sm-4 td-product text-center clear-padding wow slideInUp"
                                ...
                                <div class="overlay">
                                    <div class="wrapper">
                                        ...
                                        <p>Plan to visit Harare this season ? Grab the best deals on flights to Zimbabwe.
                                        </p>
                            ...
                            <div class="col-md-4 col-sm-4 td-product text-center clear-padding wow slideInUp"
                                ...
                                <div class="overlay">
                                    <div class="wrapper">
                                        ...
                                        <p>One of the beautiful cities of Asia; we're offering the lowest rates on Bangkok
                                            flights.</p>
                                        <a href="/Flights-To-Bangkok">BOOK NOW</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-4 td-product text-center clear-padding wow slideInUp"
                                ...
                                <div class="overlay">
                                    <div class="wrapper">
                                        ...
                                        <p>Visiting Lagos was never so affordable before. Book your cheap flights to Nigeria
                                            with us.</p>
            ...
            <div class="row choose-us-row">
                <div class="container clear-padding">
                    <div class="light-section-title text-center">
                        ...
                        <div class="space"></div>
                        <p style="text-align:center;">Our aim is to provide you with best services at unbeatable prices,
                            this is why a wide range of passengers love to travel with us, <br>So just sit back, relax and
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 wow slideInLeft">
                        <div class="choose-us-item text-center">
                            ...
                            <p style="text-align:center;">We offer the best lowest price with full guarantee of marking no
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 wow slideInUp">
                        <div class="choose-us-item text-center">
                            ...
                            <p style="text-align:center;">Pay £ 50 as an initial payment and remaining balance later. Call
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 wow slideInDown">
                        <div class="choose-us-item text-center">
                            ...
                            <p style="text-align:center;">We are privileged enough to maintain a big clientele – having
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 wow slideInRight">
                        <div class="choose-us-item text-center">
                            ...
                            <p style="text-align:center;">Off course, Book with full confidence; we provide the most valued
